...
/*function shop (goods_name,  goods_quantity, price) {

 buying_goods.push(date);
    buying_goods.push(cashier);
    buying_goods.push(goods_name);
    buying_goods.push(goods_group);
    buying_goods.push(goods_quantity);
    buying_goods.push(price);
    buying_goods.push(revenue);
    buying_log.push(buying_goods);

    console.log(buying_goods);
    console.log(buying_log);
}
